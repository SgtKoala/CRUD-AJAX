...
$route['home'] = 'TestController/index';
$route['displayHome'] = 'TestController/displayHome';
$route['user_home'] = 'TestController/user_index';
$route['create'] = 'TestController/create';
$route['edit'] = 'testcontroller/edit';
$route['update'] = 'testcontroller/update';
$route['fetch'] = 'testcontroller/fetch';
...
$route['ordinary_home']='testcontroller/user_home';
